...
AREA_CONFIG = {
    ...
    "Drywall": {
        "fields": [
            ("tipo_servico", "Tipo de serviço", "Parede em drywall"),
            ("area", "Área estimada (m²)", ""),
            ("pe_direito", "Pé-direito / altura", ""),
            ("chapa", "Tipo de chapa", "ST - Standard"),
            ("camadas", "Quantidade de camadas", "1 chapa por face"),
            ("estrutura", "Estrutura metálica", "Guias e montantes galvanizados"),
            ("isolamento", "Isolamento interno", "Sem isolamento"),
            ("acabamento", "Acabamento", "Tratamento de juntas pronto para pintura"),
        ],
        "included": [
            "Medição e conferência do local antes da execução",
            "Fornecimento e montagem da estrutura metálica descrita",
            "Instalação das chapas de drywall e reforços previstos",
            "Tratamento de juntas, parafusos e encontros",
            "Limpeza básica e entrega da área executada",
        ],
        "excluded": [
            "Pintura, revestimentos decorativos e acabamentos não descritos",
            "Instalações elétricas, hidráulicas ou de climatização",
            "Reforços estruturais e correções de infiltração ou umidade",
            "Remoção de entulho ou demolições não previstas no escopo",
        ],
    },
    "Serralheria e Portões": {
        "fields": [
            ("tipo_portao", "Tipo de portão/serviço", "Portão deslizante"),
            ("vao_total", "Largura total do vão", "11,50 m"),
            ("dimensoes", "Dimensões principais", "2,80 x 2,35 m"),
            ("material", "Material / perfil", "Régua metálica 1 x 0,5 pol."),
            ("modulos_fixos", "Módulos fixos", "Vidro conforme projeto"),
            ("acabamento", "Acabamento", "Fundo anticorrosivo e pintura"),
            ("acionamento", "Acionamento", "Manual"),
            ("quantidade", "Quantidade de folhas/portões", "2"),
        ],
        "included": [
            "Medição final e conferência do vão no local",
            "Fabricação dos portões e módulos descritos",
            "Fornecimento de perfis, ferragens, roldanas e acessórios",
            "Instalação, alinhamento, regulagem e testes de funcionamento",
            "Aplicação do acabamento especificado na proposta",
        ],
        "excluded": [
            "Automatizador, controles e infraestrutura elétrica, salvo se relacionados",
            "Obras civis, demolições, alvenaria e recomposição de acabamento",
            "Vidros, fechaduras ou acessórios não descritos na relação de itens",
            "Adequações causadas por medidas divergentes após a aprovação",
        ],
    },
    "Rede": {
        "fields": [
...
class App:
    ...
    def _seed_items(self) -> None:
        samples = {
            ...
            "Drywall": [
                "1 | Estrutura metálica com guias e montantes galvanizados | 0,00 | ",
                "1 | Chapas de drywall conforme área e especificação | 0,00 | ",
                "1 | Parafusos, fitas, massas e acessórios de montagem | 0,00 | ",
                "1 | Mão de obra de montagem e tratamento de juntas | 0,00 | ",
            ],
            "Serralheria e Portões": [
                "2 | Portão deslizante em régua metálica 1 x 0,5 pol. | 0,00 | 2,80 x 2,35 m",
                "3 | Módulo fixo em vidro e estrutura metálica | 0,00 | Conforme medidas",
                "1 | Ferragens, trilhos, roldanas e acessórios | 0,00 | Kit de instalação",
                "1 | Fabricação, instalação e regulagem | 25.400,00 | Referência à vista",
            ],
            "Rede": [
