...
```text
installer-dist\Instalador_DelfosPropostas_0.3.0.exe
```

Ele instala o programa apenas para o usuário atual, cria atalhos e não remove o
banco de clientes durante atualizações ou desinstalações.
