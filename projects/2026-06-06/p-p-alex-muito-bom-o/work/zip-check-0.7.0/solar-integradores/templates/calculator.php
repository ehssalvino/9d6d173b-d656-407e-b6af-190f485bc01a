...
<section class="si-app" data-si-calculator>
    ...
    <div class="si-results" data-si-results hidden>
        ...
        <article><span><?php esc_html_e('Potência instalada', 'solar-integradores'); ?></span><strong data-si-result="installed_system_kwp">0</strong><small>kWp DC</small></article>
        <article><span><?php esc_html_e('Inversor selecionado', 'solar-integradores'); ?></span><strong><span data-si-result="inverter_count">0</span> × <span data-si-result="inverter_unit_power_kw">0</span></strong><small>kW por inversor</small></article>
        <article><span><?php esc_html_e('Overload DC/AC', 'solar-integradores'); ?></span><strong data-si-result="inverter_overload_percent">0</strong><small>%</small></article>
