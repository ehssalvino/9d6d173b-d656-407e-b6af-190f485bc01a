...
<body>
<div class="toolbar"><button type="button" onclick="window.print()"><?php esc_html_e('Imprimir ou salvar em PDF', 'solar-integradores'); ?></button></div>
<main class="proposal">
    ...
    <section class="page">
        ...
        <table>
            ...
            <tbody>
            <tr><td>Módulos fotovoltaicos</td><td><?php echo esc_html($equipment['module']); ?></td><td><?php echo esc_html($equipment['module_count']); ?></td></tr>
            <tr><td>Inversor(es)</td><td><?php echo esc_html($equipment['inverter']); ?></td><td>Conforme projeto</td></tr>
