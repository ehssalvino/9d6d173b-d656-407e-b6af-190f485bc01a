...
$anchor = strpos($content, '#haja-servicos-principais');
if ($anchor === false) {
    $anchor = strpos($content, '<section id="haja-servicos-principais"');
}
if ($anchor === false) {
...
if ($start === false || $next === false) {
    throw new RuntimeException('Could not isolate services section');
}
...
echo "Only four service boxes applied.\n";
